...
module.exports = {
    merchant_bank_accounts: {
        ...
        resolve: async (_, args, context) => {
            ...
            let baseQuery = `select t.* from merchant_bank_account t`
            let groupQuery = ` group by t.id`
            let items = await MerchantBankAccount.findByFields2({baseQuery, groupQuery, alias: 't.', fields: args, limit, offset, order})
